...
//         create: (ctx) => CFUserViewModel(UserInfo('cf',20,'url')),
//         child: const MyApp(),
//       ),
//     )
//   );
...
class CFShowData03 extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Consumer<CFUserViewModel>(builder: (ctx, userVM,child){
...
class CFShowData04 extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Consumer2<CFUserViewModel,CFCounterViewModel>(builder: (ctx, userVM, counterVM, child){
      return Text(
